...
function ProjectEditForm() {
  ...
  const projectId = editId ? Number(editId) : MOCK_PROJECTS[0]?.id || 1;
          ...
          <div className="flex flex-col gap-4 rounded-3xl border border-slate-200 bg-white/85 p-6 shadow-sm backdrop-blur-xl md:flex-row md:items-center md:justify-between">
            <div className="space-y-1.5">
              ...
              <h1 className="font-display text-2xl font-bold tracking-tight text-slate-900 sm:text-3xl">
                Edit Project: {formData.name || "Project"}
              </h1>
              <p className="text-xs text-slate-600 sm:text-sm">
                Update project milestones, timeline, valuation, and assigned team members.
              </p>
            </div>

            <div className="flex items-center gap-3">
              <Link href={`/projects/view?id=${projectId}`}>
                <Button
                  type="button"
                  variant="outline"
                  ...
                  <CardHeader className="border-b border-slate-100 bg-slate-50/50 pb-4">
                    <div className="flex items-center gap-2">
                      ...
                      <div>
                        ...
                        <CardDescription className="text-xs text-slate-500">
                          Target delivery dates and timeline
                        </CardDescription>
                      </div>
                    </div>
                  </CardHeader>
