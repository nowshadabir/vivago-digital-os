               ...
               <Card className="w-full max-w-2xl border-slate-200 bg-white shadow-2xl rounded-[32px] overflow-hidden">
                  ...
                  <CardContent className="p-8">
                     <form onSubmit={saveMember} className="space-y-6">
                        ...
                        <div className="grid gap-6 md:grid-cols-2">
                           <div className="space-y-2"><Label className="text-xs font-bold uppercase text-slate-400">Comms Frequency (Email)</Label><Input type="email" value={formData.email} onChange={e => setFormData({ ...formData, email: e.target.value })} className="h-11 rounded-2xl" placeholder="email@getvivago.com" required /></div>
